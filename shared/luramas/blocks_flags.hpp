...
namespace luramas::blocks::flags {
      ...
      struct finsts {
            ...
            inline constexpr bool compare(const finsts &other) const {
                  ...
                  return std::tie(this->fbranching, this->fconditional_jump, this->fself_modified, this->fexited, this->fexecuted, this->ftaken_condbranch, this->fentry, this->fref) ==
                         std::tie(other.fbranching, other.fconditional_jump, other.fself_modified, other.fexited, other.fexecuted, other.ftaken_condbranch, other.fentry, other.fref);
            }
